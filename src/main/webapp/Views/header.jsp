...
<head>
    ...
    <link rel="shortcut icon" href="<c:url value='/resources/outlook_calendar_day.ico' />">
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<c:url value='/resources/css/rar/rar.style.css' />">
...
<nav class="navbar navbar-default" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="${pageContext.servletContext.contextPath}/">Rent a Room</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <sec:authorize access="hasRole('ROLE_ADMIN')">
            ...
            <ul class="nav navbar-nav">
                <c:choose>
                    ...
                    <a href="<c:url value="${pageContext.servletContext.contextPath}/rooms" />">Zimmer</a></li>
            </ul>
        </sec:authorize>
        ...
        <ul class="nav navbar-nav">
            ...
            <a href="<c:url value="${pageContext.servletContext.contextPath}/about" />">&Uuml;ber</a></li>
        </ul>

        <sec:authorize access="hasRole('ROLE_ADMIN')">
            <form class="navbar-form navbar-right" role="search" accept-charset="UTF-8"
                  action="<c:url value="${pageContext.servletContext.contextPath}/logout" />">
                <div class="form-group">
